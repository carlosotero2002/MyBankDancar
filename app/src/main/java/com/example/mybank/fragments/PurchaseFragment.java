...
public class PurchaseFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        String[] qValues = new String[]{LoginActivity.loggedUser,"SAT","CFE","SIAPA"};
        Cursor c = db.rawQuery("SELECT * FROM Transacciones WHERE email_origen = ? and (motivo = ? OR motivo = ? OR motivo = ?)", qValues);
        ...
        if (c != null) {
            ...
            TextView t = view.findViewById(R.id.purchases_table);
            t.setText(table);
        }
    }
}