...
public class CreditsFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        String[] qValues = new String[]{LoginActivity.loggedUser, "HIPOTECA", "NOMINA"};
        Cursor c = db.rawQuery("SELECT * FROM Transacciones WHERE email_destino = ? AND (motivo = ? OR motivo = ?)", qValues);
        ...
        if (c != null) {
            ...
            TextView t = view.findViewById(R.id.credits_table);
            t.setText(table);
        }
    }
}